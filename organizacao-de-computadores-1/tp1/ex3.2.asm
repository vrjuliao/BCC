...
main:
  ...
  lw x14, 0(x5)
  jal x1, PERMUTATION # Calling sum and saving the next address to be executed when we return from sum
...
PERMUTATION:
    ...
    SELECTION_SORT:
		#x12 = primeira posicao do vetor
        #x13 = tamanho do vetor
        
    	#save registers data
    	addi sp, sp, -20
#navegadores do array
	    sw x5, 0(sp)
    	sw x6, 4(sp)
#x7 = Maior elemento
		sw x7, 8(sp)
#x28 = navegador do LOOP_2
	    sw x28, 12(sp)
#x29 = endereço do maior
	    sw x29, 16(sp)
